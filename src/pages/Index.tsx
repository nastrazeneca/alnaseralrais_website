        ...
        <div className="grid md:grid-cols-[280px,1fr] gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              ...
              ,{" "}
              <a
                href="https://biology.mit.edu/profile/jonathan-weissman/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent hover:underline"
              >
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              ...
              <a
                href="https://research.google/teams/health/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent hover:underline"
              >
              ...
              <a
                href="https://en.wikipedia.org/wiki/Amyotrophic_lateral_sclerosis"
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent hover:underline"
              >
              ...
              and{" "}
              <a
                href="https://en.wikipedia.org/wiki/Adrenoleukodystrophy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-accent hover:underline"
              >
