        ...
        <BrowserRouter>
          <NavigationHandler>
            <div className="relative min-h-screen overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-[180%] h-[70vh] bg-accent origin-bottom-right -rotate-[15deg] translate-x-[35%] translate-y-[25%] opacity-[0.15] blur-[100px] pointer-events-none" />
