        ...
        <BrowserRouter>
          <NavigationHandler>
            <div className="relative min-h-screen overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-[200%] h-[80vh] bg-accent origin-bottom-right -rotate-12 translate-x-[30%] translate-y-[30%] opacity-15 blur-3xl pointer-events-none" />
