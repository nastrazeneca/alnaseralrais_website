        ...
        <BrowserRouter>
          <NavigationHandler>
            <div className="relative min-h-screen overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-[300%] h-[110vh] bg-accent origin-bottom-right -rotate-[15deg] translate-x-[25%] translate-y-[15%] opacity-[0.15] blur-[100px] pointer-events-none" />
